...
export const citizenshipV4RC1Context = {
  '@context': {
    ...
    Person: {
      ...
      '@context': {
        ...
        marriageCertificateNumber:
          'https://w3id.org/citizenship#marriageCertificateNumber',
        marriageLocation: {
    ...
    PermanentResidentCardCredential:
      'https://w3id.org/citizenship#PermanentResidentCardCredential',
    ...
    EmploymentAuthorizationDocumentCredential:
      'https://w3id.org/citizenship#EmploymentAuthorizationDocumentCredential',
    ...
    CertificateOfNaturalization: {
      ...
      '@context': {
        ...
        insRegistrationNumber:
          'https://w3id.org/citizenship#insRegistrationNumber'
      }
    },

    CertificateOfNaturalizationCredential:
      'https://w3id.org/citizenship#CertificateOfNaturalizationCredential',
    ...
    CertificateOfCitizenship: {
      ...
      '@context': {
        ...
        cisRegistrationNumber:
          'https://w3id.org/citizenship#cisRegistrationNumber'
      }
    },

    CertificateOfCitizenshipCredential:
      'https://w3id.org/citizenship#CertificateOfCitizenshipCredential'
  }
}
